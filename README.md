...
- **Anushka Hebbar - ash233**: Worked on the user account creation, sign in, profile page, house listing browsing, search filtering, map integration for house listings, post creation, and user listing workflows. Worked on UI rehaul to make the wireframe look high-fidelity.
